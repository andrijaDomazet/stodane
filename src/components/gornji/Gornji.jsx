          ...
          <div className="col-sm-6 text">
            <div className="unutrasnjiDiv">
              ...
              <p className="textstyle">
                Budite među prvih 100 kupaca Tesla Smartphone-a 9.2, <br /> jer
                na poklon dobijate Tesla Tablet L7.1! <br />{" "}
                <strong>Dva uređaja po ceni jednog - pa STO da ne?</strong>{" "}
              </p>
              <p className="lead">
